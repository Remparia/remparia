...
export const HOME = {
  fr: {
    ...
    sub: "Nos agents prennent en charge le répétitif, dans vos outils et sous vos règles — avec vos données sous contrôle.",
  ...
  en: {
    ...
    sub: "Our agents handle repetitive work inside your tools and under your rules — with your data under control.",
