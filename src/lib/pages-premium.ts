    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { title: "Compétences", desc: "Capacités réutilisables, versionnées." },
          { title: "Outils", desc: "Connecteurs CRM, ERP, email, GED, APIs." },
          { title: "Connaissance", desc: "Règles et sources autorisées." },
          { title: "Workflows", desc: "Enchaînements et escalades." },
          { title: "Validations humaines", desc: "Décisions engagantes toujours humaines." },
        ],
      },
      {
        id: "protocole",
...
const governance = {
  fr: {
    ...
    sub: "Le risque n’est pas le futur rollout. C’est l’IA non gouvernée déjà en cours. Remparia pose les rails dans l’OS — ALLOW / REVIEW / BLOCK — pas un PDF.",
    ...
    sections: [
      {
        ...
        body: "L’adoption n’attend pas la permission. Données réelles dans des logins non validés.",
        list: [
  ...
  en: {
    ...
    sub: "The risk is not the future rollout. It is the ungoverned AI already running. Remparia puts the rails in the OS — ALLOW / REVIEW / BLOCK — not a PDF.",
    ...
    sections: [
      {
        ...
        eyebrow: "01 / CONSTAT",
        title: "Là où le temps disparaît",
        body: "Les dossiers saturent avant l’audience. La revue, la collecte et les contrôles absorbent l’expertise — sans que la machine puisse décider à votre place.",
        list: [
...
const commerce = {
  fr: {
    ...
    sub: "Un agent qui conseille, compose le panier et suit la commande — sans jamais toucher au paiement. Sécurité dans le code, formation incluse, exploitation continue.",
  ...
  en: {
    ...
    sub: "An agent that advises, builds the cart and tracks the order — without ever touching payment. Security in code, training included, continuous operations.",
